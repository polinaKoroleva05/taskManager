import {
  ...
  useRandomClassName,
  useStyles
} from "./chunk-FNZQK7NH.js";
import {
  require_jsx_runtime
} from "./chunk-XREXF2BJ.js";
import "./chunk-SPLJIEEX.js";
import {
  __toESM,
  require_react
...
function CarouselContainerVariables({
  ...
  return (0, import_jsx_runtime2.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var Carousel = factory((_props, ref) => {
  ...
  }, [import_react2.Children.toArray(children).length, emblaOptions?.slidesToScroll]);
  ...
  return (0, import_jsx_runtime3.jsxs)(CarouselProvider, { value: { getStyles, orientation }, children: [
    type === "container" ? (0, import_jsx_runtime3.jsx)(CarouselContainerVariables, { ...props, selector: `.${responsiveClassName}` }) : (0, import_jsx_runtime3.jsx)(CarouselVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime3.jsxs)(
      Box,
      {
        ...
        children: [
          (0, import_jsx_runtime3.jsx)("div", { ...getStyles("viewport"), ref: emblaRefElement, "data-type": type, children: (0, import_jsx_runtime3.jsx)(
            "div",
            {
